...
char *physNames [64] = 
{
 ...
 "          3.3V ", " 5V            ", //1, 2      
 "      PI8/SDA1 ", " 5V            ", //3, 4   264
 "      PI7/SCL1 ", " GND           ", //5, 6   263
 " PI0/I2S0-MCLK ", " TX0           ", //7, 8   256
 "           GND ", " RX0           ", //9, 10 
 "           TX5 ", " PI1           ", //11, 12 
 "           RX5 ", " GND           ", //13, 14 
 " PI13/TX4/PWM3 ", " PI14/RX4/PWM4 ", //15, 16
 "          3.3V ", " PH4           ", //17, 18 
 "         MOSI1 ", " GND           ", //19, 20 
 "         MISO1 ", " PI6/RX2       ", //21, 22
 "         SCLK1 ", " CS0           ", //23, 24 
 "           GND ", " CS1           ", //25, 26 
 "     PI10/SDA2 ", " PI9/SCL2      ", //27, 28
 "          PI11 ", " GND           ", //29, 30 
 "          PI12 ", " PI5/TX2       ", //31, 32 
 "          PI15 ", " GND           ", //33, 34 
 "  PI2/I2S0-LRC ", " PH10          ", //35, 36 
 "          PI16 ", " PI4/I2S0-DOUT ", //37, 38 
 "           GND ", " PI3/I2S0-DIN  ", //39, 40 
